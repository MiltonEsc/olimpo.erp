...
$(document).ready(function(){
    ...
    //tabla para los documentos adicionales
...
$(document).on("click","#btnenviar", function(){
    ...
    var cate_nom = $('#cat_nom').val();

    //VARIABLES INGRESO USUARIO
    ...
    if(cate_nom == "Ingreso de Usuario nuevo en el sistema"){
        ...
        if($.trim(tipo_linea_tele) == "" && $.trim(linea_tele) == "1"){
         ...
         $.ajax({
          type:"POST",
          url:"../../controller/ticket.php?op=insertdetalle_ingreso",
          data:{tick_id:tick_id,usu_id:usu_id,tickd_descrip:tickd_descrip,linea_tele:linea_tele,tipo_linea_tele:tipo_linea_tele,divisiones:divisiones,opciones_ibes:opciones_ibes,copia_ibes:copia_ibes,opcion_copia_usu_ibes:opcion_copia_usu_ibes,adicional:adicional,excepcion:excepcion,programas:programas},
          beforeSend: function(){
            swal({
              title: "Enviando...",
          ...
          success:function(respuesta) {	
            ...
            var enviar = $.post("../../controller/ticket.php?op=update", { tick_id : tick_id,usu_id : usu_id }, function (data) {});
...
// listar la respuesta de los tickets
...
function listardetalle_ingreso(tick_id){
    ...
    $.post("../../controller/ticket.php?op=listardetalle_ingreso", { tick_id : tick_id }, function (data) {
        $('#lbldetalle').html(data);
    }); 
