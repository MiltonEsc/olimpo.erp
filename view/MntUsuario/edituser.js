...
const usu_id = urlSearchParams.get("id");
...
mostrar(usu_id);
  ...
  $.post("../../controller/departamento.php?op=editar_combo",{ usu_id: usu_id },function(data, status){
    $('#usu_dpto').html(data);
});
      ...
      // Cuando se resuelva la promesa traerá el canvas
         ...
         $.ajax({
          ...
          success:function(respuesta) {	
            ...
            if (respuesta > 0) {
              var enviar = $.post("../../controller/email.php?op=mensaje_cumpleanios", {tick_id : usu_id});
         ...
         $.ajax({
          ...
          success:function(respuesta) {	
            ...
            if (respuesta > 0) {
              ...
              toastr.success("Foto tomada exitosamente","Aviso!");
      ...
      // Cuando se resuelva la promesa traerá el canvas
         ...
         $.ajax({
          ...
          success:function(respuesta) {	
            ...
            respuesta = parseInt(respuesta);
            if (respuesta > 0) {
              var enviar = $.post("../../controller/email.php?op=mensaje_bienvenida", {tick_id : usu_id});

              enviar.done(function( data ) {
                toastr.success("mensaje bienvenida enviado con exito!","Aviso!");
                var form_ingreso = $.post("../../controller/email.php?op=form_ingreso", {tick_id : usu_id});
      ...
      // Cuando se resuelva la promesa traerá el canvas
         ...
         $.ajax({
          ...
          success:function(respuesta) {	
            ...
            console.log(respuesta);
            if (respuesta > 0) {
              var enviar = $.post("../../controller/email.php?op=mensaje_despedida", {tick_id : usu_id});
