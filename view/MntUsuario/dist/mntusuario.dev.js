...
$(document).ready(function () {
  ...
  }).DataTable(); //tabla de usuarios inactivos
...
function eliminar(usu_id) {
  swal({
    ...
    if (isConfirm) {
      $.get("../../controller/usuario.php?op=eliminar", {
        usu_id: usu_id
      }, function (data) {});
...
function habilitar_usuario(usu_id) {
  swal({
    ...
    if (isConfirm) {
      $.post("../../controller/usuario.php?op=habilitar_usuario", {
        usu_id: usu_id
      }, function (data) {});
      $('#usuario_data').DataTable().ajax.reload();
      $('#usuario_inactivos_data').DataTable().ajax.reload();
...
function eliminar_usuario_raiz(usu_id) {
  swal({
    ...
    if (isConfirm) {
      var enviar = $.post("../../controller/usuario.php?op=eliminar_usuario_raiz", {
        usu_id: usu_id
      }, function (data) {});
