...
$(document).ready(function () {
  ...
  }).DataTable(); //tabla de departamento inactivos
  ...
  }).DataTable(); // formulario guardar y editar
...
function editar(id_departamento) {
  $('#mdltitulo').html('Editar Registro');
  $.post("../../controller/departamento.php?op=mostrar", {
...
function eliminar(id_departamento) {
  swal({
    ...
    if (isConfirm) {
      $.post("../../controller/departamento.php?op=eliminar", {
        id_departamento: id_departamento
      }, function (data) {});
      $('#usuario_data').DataTable().ajax.reload();
...
function habilitar_usuario(id_departamento) {
  swal({
    ...
    if (isConfirm) {
      $.post("../../controller/departamento.php?op=habilitar_departamento", {
        id_departamento: id_departamento
      }, function (data) {});
      $('#usuario_data').DataTable().ajax.reload();
      $('#usuario_inactivos_data').DataTable().ajax.reload();
...
function eliminar_usuario_raiz(id_departamento) {
  swal({
    ...
    if (isConfirm) {
      $.post("../../controller/departamento.php?op=eliminar_departamento_raiz", {
        id_departamento: id_departamento
      }, function (data) {});
      $('#usuario_inactivos_data').DataTable().ajax.reload();
      $('#usuario_data').DataTable().ajax.reload();
