...
function guardaryeditar(e) {
  ...
  if ($('#cat_id').val() == 6) {
    ...
    var correo = $('#correo').val(); // ESTOS CAMPOS SON POR DEFECTO DE UN TICKET NORMAL
    ...
    $.post("../../controller/ticket.php?op=insert", {
      usu_id: usu_id,
      cat_id: cat_id,
      ...
      var enviar = $.post("../../controller/usuario.php?op=guardar_usuario", {
        usu_nom: nom_emp,
        usu_ape: ape_emp,
        usu_correo: correo,
        usu_pass: usu_cedula,
      ...
      enviar.done(function (data) {
        // $.post("../../controller/email.php?op=ticket_abierto", {tick_id : data[0].tick_id, usu_correo:correo}, function (data) {
        // });
    ...
    if ($('#tick_descrip').summernote('isEmpty')) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $.post("../../controller/email.php?op=ticket_abierto", {
